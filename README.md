...
## Usage
Simply navigate into the `web_src` folder, start the local dev server using `npm run dev` and navigate to `http://localhost:3000`. You can view the curriculum progression map, open individual lessons, and view real-time Python diagrams and callouts.
